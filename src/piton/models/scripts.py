...
def create_dictionary() -> None:
    ...
    piton.extension.dataloader.create_dictionary(args.data_path, args.output_file)
...
def train_model() -> None:
    ...
    loader = piton.models.dataloader.BatchLoader(args.data_path, batch_info_path)
...
def compute_representations() -> None:
    ...
    loader = piton.extension.dataloader.BatchLoader(args.data_path, batch_info_path)
