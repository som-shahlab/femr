...
from .core import (
    FixedTimeHorizonEventLabeler,
    InfiniteTimeHorizonEventLabeler,
    InfiniteTimeHorizon,
    Label,
    Labeler,
    LabelType,
...
##########################################################
##########################################################
# Abstract classes derived from FixedTimeHorizonEventLabeler
##########################################################
##########################################################
...
class DiabetesCodeLabeler(CodeLabeler):
