...
from femr.labelers.omop import CodeLabeler, WithinVisitLabeler, get_icu_events, does_exist_event_within_time_range, get_death_concepts, map_omop_concept_codes_to_femr_codes, move_datetime_to_end_of_day
from femr.labelers.omop_inpatient_admissions import WithinInpatientVisitLabeler, InpatientLongAdmissionLabeler, InpatientReadmissionLabeler, get_inpatient_admission_discharge_times
...
class FirstDiagnosisTimeHorizonCodeLabeler(Labeler):
    ...
    def __init__(
        ...
        assert self.root_concept_code is not None, "Must specify `root_concept_code` for `FirstDiagnosisTimeHorizonCodeLabeler`"
        self.ontology = ontology
