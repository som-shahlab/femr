"""
An ETL script for doing an end to end transform of MIMIC OMOP into a PatientDatabase.
"""
...
def etl_mimic_omop_program() -> None:
    """Extract data from an MIMIC OMOP source to create a FEMR PatientDatabase."""
    parser = argparse.ArgumentParser(description="An extraction tool for MIMIC-OMOP sources")
