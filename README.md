...
**FEMR** by default supports the [OMOP Common Data Model](https://www.ohdsi.org/data-standardization/) developed by the OHDSI community (https://www.ohdsi.org/data-standardization/), but can also be used with other forms of EHR / claims data with minimal processing. Data that has been used with **FEMR** includes MIMIC-IV, Optum, Truven, STARR-OMOP, and SickKids-OMOP. 
