...
PATH_TO_TEMP_DIR = "/local-scratch/nigam/projects/mwornow/data/"
...
if __name__ == '__main__':
    # Constants
    path_to_temp_dir = os.path.join(PATH_TO_TEMP_DIR, 'test_mortality_longformer')
    path_to_model: str = os.path.join(PATH_TO_MODELS_DIR, 'Clinical-Longformer')
    n_cpu_jobs: int = 10
    gpu_devices: List = [1, 2] # get_gpus_with_minimum_free_memory(10)
    ...
    note_featurizer = NoteFeaturizer(path_to_patient_database=PATH_TO_PATIENT_DATABASE_FULL_EXTRACT,
                                    ...
                                    path_to_output_dir=path_to_temp_dir, 
    ...
    result_tuple = note_featurizer.featurize(labeled_patients, num_patients_per_chunk = 1e4, is_debug = False)
